...
void ofApp::setup()
{
    ...
    for (auto& device: ofxIO::SerialDeviceUtils::listDevices("/dev/cu.usbserial"))
    {
        printers.push_back(ESCPOS::SerialPrinter());
...
void ofApp::imageTest(ESCPOS::SerialPrinter& printer)
{
    printer.printImage(image);
}


void ofApp::printerTest(ESCPOS::SerialPrinter& printer)
{
